  ...
  Alpine.data(
    ...
    makeExplorer({
      ...
      items: [
        ...
        { id: '/session fork', category: 'Session', desc: 'Branch the current session into a new one' },
        ...
        { id: '/config advisor', category: 'Model', desc: 'Set a secondary advisor model' },
        { id: '/effort fast', category: 'Model', desc: 'Toggle fast mode (smaller, faster model)' },
        // Config
        ...
        { id: '/config output-style', category: 'Config', desc: 'Switch output style' },
        { id: '/config theme', category: 'Config', desc: 'Switch visual theme' },
        // Code & Git
        ...
        { id: '/usage stats', category: 'Memory & Cost', desc: 'Session statistics' },
        ...
        { id: '/login switch', category: 'Auth', desc: 'Switch active account' },
        { id: '/logout', category: 'Auth', desc: 'Clear credentials' },
        { id: '/login refresh', category: 'Auth', desc: 'Refresh OAuth tokens' },
        // Display
        ...
        { id: '/export copy', category: 'Diagnostics', desc: 'Copy last response to clipboard', keywords: 'clipboard' },
        { id: '/thinking back', category: 'Diagnostics', desc: 'View thinking traces from previous responses' },
  ...
  Alpine.data(
    ...
    makeExplorer({
      ...
      items: [
        ...
        // Subagent lifecycle
        { id: 'SubagentStart',      category: 'Subagent',     desc: 'Fires when a sub-agent is spawned (e.g., coordinator worker, /agent launch).',                                                                         keywords: 'agent spawn worker' },
