...
export const STATIC_PALETTE_ITEMS = [
  ...
  ...slash([
    ...
    ['/fork',            'Session',         'Branch the current session into a new one'],
    ...
    ['/fast',            'Model',           'Toggle fast mode (smaller, faster model)'],
    ['/config',          'Config',          'Open the settings editor'],
    ['/keybindings',     'Config',          'Open the interactive keybinding editor'],
    ['/permissions',     'Config',          'Manage tool permission rules'],
    ['/hooks',           'Config',          'Inspect active hooks'],
    ['/mcp',             'Config',          'Manage MCP servers'],
    ['/output-style',    'Config',          'Switch output style'],
    ['/theme',           'Config',          'Switch visual theme'],
    ['/vim',             'Config',          'Toggle vim mode'],
    ['/voice',           'Config',          'Voice input mode'],
    ['/commit',          'Code & Git',      'Stage and commit current changes'],
    ['/diff',            'Code & Git',      'Show working-tree diff'],
    ['/undo',            'Code & Git',      'Undo the last file edit'],
    ...
    ['/context',         'Memory & Cost',   'Show context window usage'],
    ['/cost',            'Memory & Cost',   'Token usage and dollar cost for the session'],
    ['/insights',        'Memory & Cost',   'Session statistics and tool usage report'],
    ['/agents',          'Agents & Tasks',  'List built-in, custom, and familiar agents'],
    ...
    ['/switch',          'Auth',            'Switch active account'],
    ['/logout',          'Auth',            'Clear credentials'],
    ['/refresh',         'Auth',            'Refresh OAuth tokens'],
    ...
    ['/doctor',          'Diagnostics',     'Environment and substrate health check'],
    ...
    ['/copy',            'Diagnostics',     'Copy last response to clipboard'],
    ['/think-back',      'Diagnostics',     'View thinking traces from previous responses'],
  ], '#commands'),
