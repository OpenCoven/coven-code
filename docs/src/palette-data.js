...
export const STATIC_PALETTE_ITEMS = [
  ...
  ...slash([
    ...
    ['/familiar list',   'Agents & Tasks',  'List built-in, custom, and familiar agents'],
    ['/familiar',        'Agents & Tasks',  'Your familiar & agents — switch, inspect, manage'],
    ['/tasks',           'Agents & Tasks',  'Show the live task list'],
    ['/goal',            'Agents & Tasks',  'Set an autonomous multi-turn goal'],
    ['/familiar managed', 'Agents & Tasks', 'Configure manager-executor agents'],
