...
> **Attribution:** Coven Code is derived from Claurst v0.0.18 under the GNU General Public License v3.0. The full license is in [`LICENSE.md`](LICENSE.md) and upstream attribution is in [`ATTRIBUTION.md`](ATTRIBUTION.md).
...
> **Beta (v0.0.18).** Core agent, multi-provider routing, and TUI are stable for daily use. Experimental features are flagged below.
